...
View::load("view/templates/infoCliente.html");
foreach ($dados as $value) {
    $html .= View::show($value);
}

$cliente['infoCliente'] = $html;

View::load("../templates/footer.tpl.html");
$footer = View::show($arrayVazio);

$cliente['navbar'] = $navbar;
$cliente['footer'] = $footer;

View::load("./view/cliente.html");
echo View::show($cliente);
